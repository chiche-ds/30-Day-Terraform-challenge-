...
- **Task Completed:** I understood the necessity of having a production-grade code and refactored my existing code to match the standards
- **Date and Time:** 9/09/2024 00:50 AM 

## Terraform Code 
Refactored the code to be used in a production-grade standards
...
###modules/services/hello-world-app/user-data.sh
```hcl
#!/bin/bash
