...
- **Name:** Eddie Chem
- **Task Completed:** Completed video tasks and documentation content on Terraform conditionals. Learned how to implement conditionals like  and `for` in Terraform for
reusable and efficient code across various environments.
- **Date and Time:** Date: 9/16/2024 Time: 12:24 PM
...
resource "aws_launch_configuration" "terraform_instance" {
...
resource "aws_autoscaling_group" "example" {
  launch_configuration = aws_launch_configuration.terraform_instance.name
